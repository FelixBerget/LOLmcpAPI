...
The skill file is here and should be plug and play just upload it to your Claude.
...
This can be put in its own folder and then connected via the config. This will give access to a skill called "riot" this is the right one.
