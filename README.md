...
This can be put in its own folder and then connected via the config. This will give access to a skill called "riot" it should be here (%APPDATA%\Claude\claude_desktop_config.json) on windows and (~/Library/Application Support/Claude/claude_desktop_config.json) on mac
